...
data:extend {
  ...
  {
    name = "em_source_teleporters_require_power",
    setting_type = "startup",
    type = "bool-setting",
    default_value = true,
    order = "i-a-source"
  ...
  {
    name = "em_dest_teleporters_require_power",
    setting_type = "startup",
    type = "bool-setting",
    default_value = true,
    order = "i-b-dest"
  ...
  {
    name = "em_all_teleporters_available",
    setting_type = "startup",
    type = "bool-setting",
    default_value = false,
    order = "j-enable-all"
  ...
  {
    name = "em_spawn_city_united_states",
    setting_type = "startup",
    type = "string-setting",
  ...
  {
    name = "em_silo_city_united_states",
    setting_type = "startup",
    type = "string-setting",
    allowed_values = Worlds["Earth - United States"].city_names,
    default_value = Worlds["Earth - United States"].city_names[1],
